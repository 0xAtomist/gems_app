...
from api_functions import get_gem_info, get_gem_list, get_api_markets, get_api_inspections, get_period_chart_data
...
for gem in gem_list:
    ...
    for period in [1, 7, 14, 30, 90, 180, 365]:
        df_p, df_m = get_period_chart_data(gem, period)
        time.sleep(1)
        context = pa.default_serialization_context()
